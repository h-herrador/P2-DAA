...
# insertion sort
table = x.create_table(lengths = [500 * 2**i for i in range(5)], fun = x.sort_functions[0], array_type = "random", bounds = insertion[0])
x.show_table(table, names = [insertion[0][i][1] for i in range(3)])

table = x.create_table(lengths = [4000 * 2**i for i in range(5)], fun = x.sort_functions[0], array_type = "sorted", bounds = insertion[1])
x.show_table(table, names = [insertion[1][i][1] for i in range(3)])

table = x.create_table(lengths = [50 * 2**i for i in range(5)], fun = x.sort_functions[0], array_type = "inverse", bounds = insertion[2])
x.show_table(table, names = [insertion[2][i][1] for i in range(3)])

# bubble sort
table = x.create_table(lengths = [200 * 2**i for i in range(5)], fun = x.sort_functions[1], array_type = "random", bounds = bubble[0])
x.show_table(table, names = [bubble[0][i][1] for i in range(3)])

table = x.create_table(lengths = [200 * 2**i for i in range(5)], fun = x.sort_functions[1], array_type = "sorted", bounds = bubble[1])
x.show_table(table, names = [bubble[1][i][1] for i in range(3)])

table = x.create_table(lengths = [200 * 2**i for i in range(5)], fun = x.sort_functions[1], array_type = "inverse", bounds = bubble[2])
